    ...
    <CategoryLanding
      config={{
        ...
        highlights: [
          ...
          { icon: Bot, title: 'Granu | A sua IA', desc: 'A IA do sistema inteiro. Pergunte o que vai faltar, o DRE do mês ou o ticket do iFood — número, evidência e o que fazer agora.' },
        ],
