...
function PhoneShell({
  ...
  return (
    <div className="granu-device w-full max-w-[248px] sm:w-[248px] sm:max-w-none lg:w-[268px] h-[460px] sm:h-[500px] lg:h-[520px] flex flex-col rounded-[26px] bg-[#E4DDD2] p-[3px] shadow-[0_10px_28px_rgba(36,29,26,.12)]">
