...
const steps = [
  ...
  { icon: MessageCircle, title: 'Consultor entra em contato via WhatsApp', time: 'Em até 2 horas', done: false },
  { icon: Calendar, title: 'Reunião de onboarding agendada', time: 'Em até 24 horas', done: false },
  { icon: Rocket, title: 'Sua operação começa a decolar', time: 'Em até 7 dias', done: false },
]

export function OnboardingTimeline() {
  return (
    <div className="rounded-2xl border border-[#0E0E0F]/10 bg-[#F7F7F7] p-6">
      <h3 className="font-bold text-[#0E0E0F] mb-6">Próximas etapas</h3>
